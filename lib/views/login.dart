...
class _LoginScreenState extends State<LoginScreen> {
 ...
 // StreamSubscription<QuerySnapshot> streamSub;
  ...
  Color bgColor = Color(0xFFf79646);
  ...
  _updateSharedPreferenceUser(String username, String password) async {
        ...
        ButtonTheme(
            ...
            child: RaisedButton(
              ...
              onPressed: () {
                ...
                newContact['fcmMToken'] = "123";
                newContact['fcmWToken'] = "123";
 ...
 var data = await Firestore.instance
        ...
        .getDocuments();
            if (data.documents.length == 1) {
              ...
              _updateSharedPreferenceUser(_email, _password);
